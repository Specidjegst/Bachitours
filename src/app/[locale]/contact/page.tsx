  ...
  return (
    <div className="container-x py-16 md:py-24 max-w-3xl">
      ...
      <div className="grid gap-4">
        <a href={operatorWaUrl("Hello Bachitours")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 rounded-xl2 bg-white p-5 shadow-card hover:shadow-cardHover">
